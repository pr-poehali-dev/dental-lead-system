...
const BENEFITS = [
  ...
  { icon: 'CalendarCheck', title: 'План на 90 дней', text: 'Знаете, сколько пациентов придёт в следующем квартале. Планируете бизнес, а не надеетесь.' },
];
...
const SystemSection = ({ scrollTo }: Props) => (
  <>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="mt-8 p-6 rounded-2xl bg-primary/5 border border-primary/15">
              <p className="font-display font-bold text-lg">Проблема не в отсутствии рекламы.</p>
    ...
    <section className="py-24 bg-muted/30 grid-bg">
      <div className="container">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {BENEFITS.map((b) => (
            <div key={b.title} className="bg-white rounded-2xl p-7 border border-border hover:border-primary/30 hover:shadow-md transition-all duration-300">
    ...
    <section className="py-24 bg-muted/30">
      <div className="container">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <SectionLabel text="Результат" color="text-secondary" />
